...
DECLARE_INTERFACE_IID_(IWzArchive, IUnknown, "3c39b9aa-18cc-408c-8716-c4fb2117266e") {
	...
	STDMETHOD(raw_Read)(THIS_ const unsigned char*, unsigned int, unsigned int*) PURE;
	STDMETHOD(raw_Write)(THIS_ const unsigned char*, unsigned int, unsigned int*) PURE;
	STDMETHOD(get_absoluteUOL)(THIS_ const wchar_t**) PURE;
	STDMETHOD(put_absoluteUOL)(THIS_ const wchar_t*) PURE;
...
DECLARE_INTERFACE_IID_(IWzSeekableArchive, IWzArchive, "35c1f133-7f61-496e-878f-9a1758afa9ea") {
	...
	STDMETHOD(raw_ReadLock)(THIS_ const wchar_t*, unsigned int, IWzSeekableArchive**) PURE;
