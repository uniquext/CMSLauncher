...
DECLARE_INTERFACE_IID_(IWzFont, IUnknown, "2bef046d-ccd6-445a-88c4-929fc35d30ac") {
	...
	/*** IWzFont methods ***/
	STDMETHOD(raw_Create)(THIS_ const wchar_t* sName, unsigned int uHeight, unsigned int uColor, tagVARIANT sStyle) PURE;
	STDMETHOD(get_color)(THIS_ int*) PURE;
	STDMETHOD(get_height)(THIS_ int*) PURE;
	STDMETHOD(get_fullHeight)(THIS_ int*) PURE;
	STDMETHOD(raw_CalcTextWidth)(THIS_ const wchar_t* sText, tagVARIANT vTabOrg, unsigned int*) PURE;
	STDMETHOD(raw_CalcLongestText)(THIS_ const wchar_t* sText, int nWidth, tagVARIANT vTabOrg, int*) PURE;
	STDMETHOD(raw_CalcLongestTextForGlobal)(THIS_ const wchar_t* sText, int nWidth, tagVARIANT vTabOrg, int*) PURE;
	STDMETHOD(raw_CalcLongestTextForGlobalEx)(THIS_ const wchar_t* sText, int nWidth, int* pnPosAdj, tagVARIANT vTabOrg, int*) PURE;
	STDMETHOD(raw_CalcLineCountForGlobal)(THIS_ const wchar_t* sText, int nWidth, tagVARIANT vTabOrg, int*) PURE;
	STDMETHOD(raw_DrawText)(THIS_ int nLeft, int nTop, const wchar_t* sText, IWzCanvas * pCanvas, tagVARIANT vAlpha, tagVARIANT vTabOrg) PURE;
...
DECLARE_INTERFACE_IID_(IWzCanvas, IWzSerialize, "7600dc6c-9328-4bff-9624-5b0f5c01179e") {
	...
	STDMETHOD(raw_DrawText)(THIS_ int nLeft, int nTop, const wchar_t* sText, IWzFont * pFont, tagVARIANT vAlpha, tagVARIANT vTabOrg, unsigned int*) PURE;
